...

{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Oh hell nah', 0.2], //From 0% to 19%

		['Ger Out', 0.4], //From 20% to 39%
		...
		['Fuck Yes!', 1] //The value on this one isn't used actually, since Perfect is always "1"
...

	{
		...
		if(openfl.utils.Assets.exists("assets/scripts/" + "note2.lua"))
		{
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "Ruim", 32);
